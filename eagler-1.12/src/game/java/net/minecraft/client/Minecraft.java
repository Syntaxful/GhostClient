...
public class Minecraft implements IThreadListener {
	...
	private void startGame() throws IOException {
		...
		// GHOSTCLIENT HOOK: initialize the client after Minecraft is ready
		GhostClient.init();
	}
	...
	public void runTick() throws IOException {
		// GHOSTCLIENT HOOK: pre-tick event
		GhostClient.onTickPre();
		...
		// GHOSTCLIENT HOOK: post-tick event
		GhostClient.onTickPost();
	}
	...
	private void runTickKeyboard() throws IOException {
		while (Keyboard.next()) {
			...
			// GHOSTCLIENT HOOK: key input event
			boolean keyEventState = Keyboard.getEventKeyState();
			GhostClient.onKeyInput(i, keyEventState);
