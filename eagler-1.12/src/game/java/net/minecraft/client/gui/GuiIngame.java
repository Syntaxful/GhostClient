...
public class GuiIngame extends Gui {
	...
	public void renderGameOverlay(float partialTicks) {
		...
		// GHOSTCLIENT HOOK: 2D render event (pre-HUD)
		GhostClient.onRenderPre(partialTicks);
		...
		// GHOSTCLIENT HOOK: 2D render event (post-HUD)
		GhostClient.onRenderPost(partialTicks);
	}
